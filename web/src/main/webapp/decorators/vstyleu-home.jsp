...
<body>
    ...
    <!-- <section id="advertisement">
        <div class="container">
            <img src="/themes/images/home/advertisement.jpg" alt="" />
        </div>
    </section> -->
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar" id="left-sidebar">
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href=""> <span
                                            class="pull-right">(27)</span>Albiro
                                    </a></li>
                                    <li><a href=""> <span
                                            class="pull-right">(32)</span>Ronhill
                                    </a></li>
                                    <li><a href=""> <span
                                            class="pull-right">(5)</span>Oddmolly
                                    </a></li>
                                    <li><a href=""> <span
                                            class="pull-right">(9)</span>Boudestijn
                                    </a></li>
                                    <li><a href=""> <span
                        ...
                        <div class="shipping text-center">
                            <!--shipping-->
                            <img src="/themes/images/home/shipping.jpg"
                                alt="" />
                        </div>
                        <!--/shipping-->
    ...
    <footer id="footer">
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img
                                            src="/themes/images/home/iframe1.png"
                                            alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img
                                            src="/themes/images/home/iframe2.png"
                                            alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img
                                            src="/themes/images/home/iframe3.png"
                                            alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img
                                            src="/themes/images/home/iframe4.png"
                                            alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                            <img src="/themes/images/home/map.png"
                                alt="" />
                            <p>505 S Atlantic Ave Virginia Beach,
                                VA(Virginia)</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <p>
                                    Get the most recent updates from <br />our
                                    site and be updated your self...
                                </p>
                            </form>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2013 E-Shopper.
...
<script type="text/javascript">
	function loadMoreProducts(scrollTop, moreProductsTop, renderId) {
		if ($(window).scrollTop() == $(document).height() - $(window).height()) {
			$
					.ajax({
						url : "/product/vstyleu-filter-products",
						type : "POST",
						data : {
							name : "test"
						},
							...
							if (response.products != null
								...
								for ( var i in response.products) {
									...
									productsHtml = productsHtml
											+ '<div class="col-sm-4" id="'+response.products[i].id+'">'
											+ '<div class="product-image-wrapper">'
											+ '<div class="single-products">'
											+ '<div class="productinfo text-center">'
											+ '<img src="/images/products/'+response.products[i].productName+'.jpg" alt="" />'
											+ '<h2>$56</h2>'
											+ '<p>'
